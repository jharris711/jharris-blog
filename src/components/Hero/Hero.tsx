    ...
    return (
      <>
        <section className='dark:text-gray-400 dark:bg-gray-900 body-font'>
          <h3 className='sm:text-2xl text-1xl font-medium title-font text-center dark:text-white p-2 border-b border-indigo-500'>
            Featured Post
          </h3>
          <div className='container mx-auto flex px-5 py-16 md:flex-row flex-col items-center'>
            <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
              ...
              <div className='flex justify-center'>
                ...
                <a href='/blog'>
                  <button className='ml-4 inline-flex text-white bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded '>
                    See all posts
                  </button>
                </a>
              </div>
