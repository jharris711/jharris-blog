...
const LikeButton = ({ blog_id, setShowLikeToast }: Props) => {
  ...
  return (
    <>
      <button
        onClick={handleLike}
        className='inline-flex items-center dark:bg-gray-800 bg-indigo-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0'
      >
